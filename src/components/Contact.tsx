        ...
        <Box position="relative" zIndex={1}>
          ...
          >
            ...
            <Text fontSize="sm" color="gray.500" textAlign="center" mb={2}>
              مبلمان، فضایی سرشار از خاطره و قلبی سرشار از عشق را پر خواهد کرد.
            </Text>
            <Text>
              صنعت چوب سنگیان با بیش از نیم قرن تجربه در تولید و توزیع مبلمان و
              تخت خواب مدرن، از سال ۲۰۱۲ تصمیم به ارتقاء کیفیت و کمیت محصولات
              خود با برند "اوهر" جهت حضور در بازارهای بین‌المللی گرفت.
            </Text>
            <Text mt={2}>
              در این راستا، استفاده از مشاوران، مدیران و پرسنل ایرانی و
              بین‌المللی و همچنین بهره‌گیری از ماشین‌آلات تمام اتوماتیک در دستور
              کار قرار گرفت تا محصولات به بازار جهانی عرضه شوند.
            </Text>
            ...
            <Text mt={2}>
              این موفقیت مسئولیت ما را دوچندان کرد. اکنون این مجموعه با داشتن ۳۰
              نمایندگی فعال در سراسر ایران، توانسته است با محصولات خارجی نیز
              رقابت کند.
            </Text>
          </Box>
